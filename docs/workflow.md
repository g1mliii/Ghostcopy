...
This document defines the workflow and operating principles for Claude Code when working on this repository. These rules are **non-negotiable** and override default behavior.
