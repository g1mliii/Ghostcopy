...
--
-- This DDL was applied to production on 2026-01-05 04:20:09 through the Supabase
...
-- Fix trigger to use correct enum type for target_device_type
...
BEGIN
  ...
  has_mobile_targets := (
    ...
    OR NEW.target_device_type @> ARRAY['ios'::device_type_enum]  -- contains 'ios'
    OR NEW.target_device_type @> ARRAY['android'::device_type_enum]  -- contains 'android'
  );
