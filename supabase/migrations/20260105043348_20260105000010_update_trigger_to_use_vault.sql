...
--
-- This DDL was applied to production on 2026-01-05 04:33:48 through the Supabase
...
-- Update notify_mobile_devices_on_clipboard_insert to read encrypted secrets from Vault
...
BEGIN
  ...
  IF has_mobile_targets THEN
    ...
    ELSE
      RAISE WARNING '[Clipboard Notify] SERVICE_ROLE_KEY not configured in Vault. Add it via Supabase dashboard or SQL: SELECT vault.create_secret(''your-key'', ''fcm_service_role_key'', ''...'')';
    END IF;
  ELSE
