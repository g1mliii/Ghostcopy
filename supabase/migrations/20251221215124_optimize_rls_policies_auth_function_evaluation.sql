...
--
-- This DDL was applied to production on 2025-12-21 21:51:24 through the Supabase
...
-- Drop existing policies with suboptimal auth.uid() calls
...
-- Recreate with optimized (SELECT auth.uid()) for consistent performance
