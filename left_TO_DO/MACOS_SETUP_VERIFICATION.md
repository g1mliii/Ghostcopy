...
The desktop icons are generated by `tool/generate_brand_assets.py`.
...
If it is wrong, regenerate with `tool/generate_brand_assets.py` rather than
editing the PNG; see `assets/icons/README.md`.
